...
public class TelaRestaurante extends javax.swing.JFrame {
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        if (linhaSelecionada != -1) {
            Integer id = Integer.parseInt(tblProdutos.getModel().getValueAt(linhaSelecionada, 0).toString());
            String nomeProduto = tblProdutos.getModel().getValueAt(linhaSelecionada, 1).toString();
            Double valorUnitario = Double.parseDouble(tblProdutos.getModel().getValueAt(linhaSelecionada, 3).toString());
            ...
            DefaultTableModel modeloPedido = (DefaultTableModel) tblItensP.getModel();
            modeloPedido.addRow(linhadaTabela);
    ...
    private void atualizaValorTotal(Double valor){
        ...
        tfValorTNovoP.setText(total.toString().replace('.', ','));
    }
    /**
